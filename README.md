...
1. __beautifulsoup4__ python package. This package is used for extracting/pulling out data from given web URL (HTML)
    ...
    ```
2. A parser module package. There are a couple of options like __'lxml', 'html.parser', or 'html5lib'__ but I personally use 'html5lib'. This parser functions to parse HTML that's previously extracted using __beautifulsoup__
